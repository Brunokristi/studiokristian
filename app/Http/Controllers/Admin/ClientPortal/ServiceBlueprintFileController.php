...
{
    public function open(ServiceBlueprintFolderDefinition $folder): StreamedResponse
    {
    ...
    public function download(ServiceBlueprintFolderDefinition $folder): StreamedResponse
    {
        $this->assertOpenableFile($folder);

...
class ClientPortalViewData
{
                ...
                'projects' => $projects
                    ->map(fn (Project $project) => [
                        ...
                        'unpaid_invoices_count' => (int) (
                            $project->unpaid_invoices_count ?? 0
                        ),
            ...
            [
                'project' => [
                    ...
                    'invoices' => $project->invoices
                        ->map(fn (ProjectInvoice $invoice) => $this->invoicePayload($invoice))
                        ->values(),
                ],
            ]
        );
    ...
    private function invoicePayload(ProjectInvoice $invoice): array
    {
        return [
            'id' => $invoice->id,
            ...
            'pay_url' => route('client.invoices.pay', [$invoice->project_id, $invoice]),
            'pdf_url' => route('client.invoices.pdf', [$invoice->project_id, $invoice]),
        ];
    }

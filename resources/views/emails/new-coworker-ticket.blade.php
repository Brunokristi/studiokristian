...
@section('content')
    <h1 style="margin: 0 0 24px; font-family: 'Space Mono', 'Courier New', Courier, monospace; font-size: 30px; line-height: 1.15;">New coworker ticket</h1>
    <p style="margin: 0 0 16px;"><strong>{{ $projectName }}</strong> received a new ticket from a coworker.</p>
